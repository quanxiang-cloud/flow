...
// Init event
func (n *DataUpdate) Init(ctx context.Context, eventData *EventData) error {
	fmt.Println("entry updateNode")
...
// Execute event
func (n *DataUpdate) Execute(ctx context.Context, eventData *EventData) error {
	return nil
}
